...
def main():
    parser = argparse.ArgumentParser(description="Evaluate best model checkpoints")
    ...
    results_dir = os.path.join("results", dataset_name, "best")
    ...
    for model_name in model_names:
        model_path = os.path.join(
            "checkpoints", dataset_name, model_name, "model_best.pth"
        )
